...
<Step title="Make changes">
  ```bash echo "console.log('Single PR')" > single.js ```
</Step>
...
mg might open your editor (vim, nano, etc.) so you can edit the PR title/description. It then prints a link to the PR on cubic.io.
...
Then open [cubic.io](https://cubic.io) in your browser to create the PR manually.
