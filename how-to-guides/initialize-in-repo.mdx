...
<Step title="Run mg init">
  ```bash mg init ``` This will: - Prompt you to select `main` or `master` (or
  another trunk branch) - Create a `.git/cubic_repo_config` file for storing
  config
</Step>
