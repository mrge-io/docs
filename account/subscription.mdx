...
<AccordionGroup>
  ...
  <Accordion title="How do I upgrade or downgrade seats mid-cycle?">
    ...
    Subscription**](https://www.mrge.io/settings?tab=subscription), adjust the
  ...
  <Accordion title="Will I receive an invoice or receipt?">
    Yes. After every successful payment you'll get an email receipt, and you can
    download PDF invoices anytime under **Settings → Billing → Invoices**.
  </Accordion>
