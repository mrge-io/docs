...
**cubic** is a developer-centric platform that helps you manage **stacked pull requests** more efficiently. With our lightweight CLI, **`mg`**, you can split large features into smaller, logically independent branches, making reviews faster and merges less error-prone.
...
- **Works with your GitHub workflow**: Two-way sync ensures you can merge in GitHub or in cubic's UI—whichever you prefer.
