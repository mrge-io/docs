...
<Note>
  - Rewrites history; child branches may need to rebase if they depend on the
  modified commits. - Use caution with previously pushed commits, as force
  pushes might be required.
</Note>
