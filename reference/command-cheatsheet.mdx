...
This cheatsheet provides a concise reference for all mg commands. For detailed information on each command, click the command name to view its dedicated documentation page.
