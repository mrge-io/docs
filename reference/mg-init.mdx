---
title: 'mg init'
description: 'Initialize a repository to use cubic'
---
...
<Note>
  - Requires an active `.git` directory; run `git init` first if your repo is
  fresh. - If you are using GitHub CLI authentication, ensure `gh auth login` is
  completed.
</Note>
