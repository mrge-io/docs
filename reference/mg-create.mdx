...
<Note>
  - If you forget to name a branch, mrge will prompt for one interactively
  (unless you have auto-generation turned on in `.mrgeconfig`). - For
  multi-branch flows, see [Create Stacked
  PRs](/how-to-guides/create-stacked-prs).
</Note>
