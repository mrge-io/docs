...
In **just a few steps**, you'll create **two stacked pull requests** using `mg` and see them on [cubic.io](https://cubic.io) (or GitHub).
...
<Steps>
  ...
  <Step title="Check your PRs">
    Now each branch has an associated PR on [cubic.io](https://cubic.io) or GitHub.
