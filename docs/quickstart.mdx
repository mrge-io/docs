...
- **[Create a single Pull Request](/docs/how-to-guides/create-a-pull-request)** for a simpler, one-branch flow.
- **[Keep Your Stack Updated](/docs/how-to-guides/keep-your-stack-updated)** if you need to handle merges or rebase conflicts.
- **[Merge Your Stack](/docs/how-to-guides/merge-your-stack)** in the Mrge UI once your PRs are approved.
