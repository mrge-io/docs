...
- **[Quickstart](/docs/quickstart)**: Try your first stacked PR.
- **[How-to guides](/docs/how-to-guides/create-stacked-prs)**: Learn step-by-step best practices.
- **[Command reference](/docs/reference/mg-init)**: Dive deep into each mrge command.
