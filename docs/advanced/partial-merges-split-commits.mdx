...
- **Solution**: Use [`mg split`](/docs/reference/mg-split) to separate commits, then merge or cherry-pick the relevant subset. The unmerged portion remains stacked for further development.
