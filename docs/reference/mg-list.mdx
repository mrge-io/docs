...
<Note>
  - If a branch is not recognized by mrge, it won't appear unless adopted (see [mg adopt](/docs/reference/mg-adopt)).
  - The tree reflects local config; ensure you've synced with remote to see up-to-date info.
</Note>
