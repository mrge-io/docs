...
- A repo already [initialized with `mg init`](/docs/how-to-guides/initialize-in-repo).
...
- **[Keep your stack updated](/docs/how-to-guides/keep-your-stack-updated)**: Sync from `main` if teammates add new commits.
- **[Merge your stack in Mrge](/docs/how-to-guides/merge-your-stack)**: Once each PR is ready, merge them in the right order via the Mrge UI.
