...
<Note>
  **Prerequisites**
  ...
  - [Install mg](/docs/installation) (optional for single PRs, but useful if you want to try mg's features)
  - [Initialize your repo](/docs/how-to-guides/initialize-in-repo) if you plan on using mg for pushing to mrge/GitHub
</Note>
...
You can merge your single-PR branch through **GitHub**'s UI or the **[mrge UI](/docs/how-to-guides/merge-your-stack)** (mrge can show just one PR, even if it's not a stack). Either way, once it's approved and merged, you're done!
...
<Tip>
  **Want to see mg's real power?** Check out [Create a
  Stack](/docs/how-to-guides/create-a-stack) to learn about stacking multiple
