...
4. **Exclude generated files**
   ...
   For large repositories, you can tell mrge to ignore files that don't require review. This is handy for:

   - Data files that don’t need to be reviewed
   - Auto‑generated code produced by build or code‑gen tools
   - Any other files that would make a pull request too large for mrge to process
   ...
   *.pb.go linguist-generated=true
   ...
   - Skipped entirely during **mrge**'s code review
