...
To view or manage the AI's stored feedback, use the **[AI review settings → Memory management](/ai-review/ai-review-settings)**. You can edit or remove specific items if they become outdated.
