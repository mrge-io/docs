...
description: 'Learn how to review pull requests with cubic'
---
...
A _version_ snapshot is created on **every push** to the PR branch. Switching versions lets you see **exactly what changed since you last viewed the PR**, rather than the full diff against `main`.
...
- **Review incrementally:** Select _Previous version → Latest_ to review only the new changes pushed after your last visit.
