...
Integrating cubic with Slack keeps your team updated with real-time pull request notifications directly in Slack.
...
3. **Authorize Slack**\
   Select your Slack workspace and click **Authorize** to connect cubic to Slack.

## Types of Notifications

cubic can send Slack notifications for:
...
To disconnect Slack from cubic:

- Visit your **Settings → Notifications → Slack**.
- Click **Disconnect**

Once disconnected, you will stop receiving cubic notifications in Slack.

---

_For details on how we handle your data with this integration, please see our [privacy policy](https://www.cubic.io/privacy)._
