...
- **[Create a stacked PR](/how-to-guides/create-stacked-prs)**: Demonstrates parent-child relationships when stacking multiple features.
- **[Handle updates & sync](/how-to-guides/handle-updates-sync)**: Learn how to keep branches in sync with the latest changes in `main`.
- **[Adopt or orphan a branch](/how-to-guides/adopt-or-orphan-branch)**: Manage how branches enter or leave mrge's tracking system.
