...
mrge is built on the principle that **small, incremental changes** are easier to review, test, and merge than massive commits. In a world where **AI tools** can generate large amounts of code quickly, keeping changes small and well-organized is **even more critical** for human reviewers. By stacking pull requests, you can develop feature after feature without merging each one back into `main` first, while ensuring every increment is clear, reviewable, and testable.
...
- **Create branches instantly** with `mg create <branch_name>`.
...
- **[Quickstart](/quickstart)**: Try your first stacked PR.
- **[How-to guides](/how-to-guides/create-stacked-prs)**: Learn step-by-step best practices.
- **[Command reference](/reference/mg-init)**: Dive deep into each mrge command.
